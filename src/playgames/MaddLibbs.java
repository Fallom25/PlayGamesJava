...
public class MaddLibbs extends PlayGames{
    ...
    public void runningMaddLib() {
        ...
        String mlstory;
        if(whichStory == 0) {
            mlstory = ("Once upon a time there was a princess, who lived in a "+getNoun(1)+". She longed " +
                    "for a prince who lived far, far away. So one day she "+getVerb(1)+" away in order to find the prince and his " +
                    "noble "+getNoun(2)+". As she "+getVerb(2)+"ed along a path, she fell into a "+getAdj(1)+
                    " "+ getNoun(3)+" that was "+getAdj(2)+" and about "+getNumber(1)+" feet tall. She was" +
                    " stuck in there for a very "+getAdj(3)+" time. She started "+getVerb(3)+"ing so that someone " +
                    "could hear her. At the "+getNoun(1)+" the king was getting worried, so he sent out some " +
                    ...
                    +getNoun(3)+" and put her on his "+getNoun(2)+". While they were "+getVerb(4)+"ing to " +
            ...
            mlstory = ("Pickachu and Charizard are very good friends. One day they went to go find a " + getNoun(2) + "to help " +
                    "their friend " + getNoun(1) + " catch a legendary pokemon that was very " + getAdj(1) + ". They " +
                    getVerb(1) + "ed " + "through the mountains and rivers and " + getAdj(2) + " forests for "
                    + getNumber(1) + " days. Finally they " + "found the " + getNoun(2) + " it was very " + getAdj(3) +
                    " and very " + getAdj(4) + ". They took the " + getNoun(2) + " and " + getVerb(2) + "ed back " +
                    "towards home but then a wild " + getNoun(3) + " appeared. Together" + " they battle and defeated the "
                    + getNoun(3) + " and were able to " + getVerb(3) + " it and give it to their friend "
                    + getNoun(1) + ". Now with the " + getNoun(2) + " the team went " + getVerb(4) + "ing to the "
